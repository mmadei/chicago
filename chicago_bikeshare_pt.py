...
def column_to_list(data, index):
    ...
    """
    Função para adicionar colunas de uma lista em outra lista, na mesma ordem.
    Args:
      data: Lista de dados da planilha
      index: nome da coluna
    Returns:
      Lista com a coluna de uma lista na mesma ordem.
    """
...
def count_gender(data_list):
    ...
    Returns:
      Lista com o total de masculinos e femininos
    """
...
# TODO: Crie um gráfico similar para user_types. Tenha certeza que a legenda está correta.
 """
    Função para contar user_types
    Args:
      data_list: lista com registro de user_types.
    Returns:
      Lista com quantidade de subscriber, customer e dependent 
    """
...
answer = "Porque existem linhas com gênero não preenchido"
